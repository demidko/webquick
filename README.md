...
2. Стандартный в России QUICK терминал с локальными FIX-коннекторами для разных языков. Решение доступно только для Windows. Облачные FIX коннекторы для QUICK обоходятся дорого, проще сразу рассмотреть следующий вариант.
