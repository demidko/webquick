...
2. Стандартный для России QUICK терминал с Lua, который можно расширить FIX коннектором, чтобы писать на других языках. Это Windows-специфичные решения со всеми вытекающими недостатками.
